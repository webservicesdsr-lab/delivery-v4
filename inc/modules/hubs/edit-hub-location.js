...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Polygon UI Elements
  const radiusRadio = document.querySelector('input[name="deliveryZoneType"][value="radius"]');
  const polygonRadio = document.querySelector('input[name="deliveryZoneType"][value="polygon"]');
